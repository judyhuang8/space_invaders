...
ALIEN_ROWS     = 5
# the number of rows for each type of aliens
ALIEN_ROW_NUMBER = (1,2,2)
# the number of aliens per row
ALIENS_IN_ROW  = 12
# the image files for the aliens (bottom to top)
ALIEN_IMAGES   = ('alien1.png','alien2.png','alien3.png')
# the spritesheet files for the aliens (bottom to top)
ALIEN_SPRITES   = ('alien-strip1.png','alien-strip2.png','alien-strip3.png')
...
BOLT_HEIGHT = 16
# the number of pixels to move the alien bolt per update
ALIEN_BOLT_SPEED  = 10
# the number of pixels to move the player bolt per update
PLAYER_BOLT_SPEED  = 10
...
STATE_ACTIVE   = 2
# state when we are paused from user input
STATE_PAUSED   = 3
